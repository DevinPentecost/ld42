...
"{name} is an {adjective} puppy who is about {age} old.",
...
"{name} is a bit {adjective} until {she} gets to know you.",
...
"This sweet {girl} makes everyone who meets {her} smile.",
"{she} loves playing with other puppies and exploring new things.",
"{her} favorite thing would be to explore would be a forever home!",
